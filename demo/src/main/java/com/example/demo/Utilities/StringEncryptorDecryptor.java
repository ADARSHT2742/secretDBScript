...
public class StringEncryptorDecryptor implements StringFormatter {
	...
	// byte[] privateKeyBytes = Base64.getDecoder().decode(PRIVATE_KEY.getBytes());
